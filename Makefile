...
#    Updated: 2025/08/05 18:05:04 by shunwata         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = $(addprefix $(SRC_DIR)/, error_finder.c main.c node_management.c operations1.c operations2.c operations3.c parse_args.c sort.c stack_managemant.c)
OBJ = $(SRC:.c=.o)
